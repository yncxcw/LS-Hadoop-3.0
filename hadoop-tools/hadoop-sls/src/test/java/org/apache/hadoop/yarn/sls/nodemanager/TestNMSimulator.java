...
public class TestNMSimulator {
  ...
  public void testNMSimulator() throws Exception {
    ...
    node1.init("/rack1/node1", GB * 10, 10, 0, 1000, rm,false,10);
    node1.middleStep();
    ...
    node1.addNewContainer(container1, 100000l, null, null, null, sleepInterval);
    ...
    Container container2 = Container.newInstance(cId2, null, null,
        Resources.createResource(GB, 1), null, null);
    node1.addNewContainer(container2, -1l, null, null, null, sleepInterval);
